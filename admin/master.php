...
<nav role='navigation'>
  ...
  <ul class="main">
    ...
    <li class="users"><a href="landlords.php">Upload sermons</a></li>
    <li class="users"><a href="alllandlords.php">View members</a></li>
    <li class="users"><a href="allcustomers.php"></a></li>
